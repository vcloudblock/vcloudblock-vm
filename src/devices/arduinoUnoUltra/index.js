...
class ArduinoUnoUltra{
    ...
    reset () {
        ...
        this._stopHeartbeat();
        this._runtime.removeListener(this._runtime.constructor.PROGRAM_MODE_UPDATE, this._startHeartbeat);
    ...
    _onConnect () {
        ...
        this._runtime.on(this._runtime.constructor.PROGRAM_MODE_UPDATE, this._startHeartbeat);
...
class OpenBlockArduinoUnoUltraDevice {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new ArduinoUnoUltra(this.runtime, OpenBlockArduinoUnoUltraDevice.DEVICE_ID);
    }
